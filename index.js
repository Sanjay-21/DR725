...
(function() {
  ...
  function createInfoHotspotElement(hotspot) {
    ...
    srtbtn.innerHTML = 'CC';
    srtbtn.classList.add('info-hotspot-srtbtn');
    var track = document.createElement("track");
		track.kind = "captions";
		track.label = "English";
		track.srclang = "en";
		track.src = hotspot.srt;
    ...
    srtbtn.addEventListener("click", function(){
      ...
      /*for (var i = 0; i < video.track.length; i++) {
        if(video.track[i].mode = 'showing')
        {
          video.track[i].mode = 'hidden';
        }
        else
        {
